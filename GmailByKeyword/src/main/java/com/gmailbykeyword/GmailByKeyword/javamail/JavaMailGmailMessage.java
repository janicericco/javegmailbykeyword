 ...
 */
package com.gmailbykeyword.GmailByKeyword.javamail;
...
public class JavaMailGmailMessage extends GmailMessage {
	...
	/**
	 * Gets plain text version of the content. Has some limitations - won't handle
	 * nested attachments well.
	 * 
	...
	public String toString() {
		...
		try {
			...
			toString.append("MailMessage:{from:").append(getFrom()).append(";sendDate:").append(getSendDate())
					.append(";subject:").append(getSubject()).append(";preview:").append(getPreview()).append(";}");
			return toString.toString();
		} catch (final Exception e) {
			toString = null;
